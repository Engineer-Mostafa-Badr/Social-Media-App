...
import 'package:social_media_app/feature/registration/bloc/registration_cubit.dart';
import 'package:social_media_app/data/api/firebase_database_api.dart';
import 'package:social_media_app/data/repository/firebase_auth.dart';
            ...
            switch (state.dialogsType) {
              ...
              case DialogsType.showDatePicker:
                await showDatePicker(
                  ...
                  (value) => context.read<RegistrationCubit>().onSelectedDate(
                    date: value,
                  ),
                );
              default:
