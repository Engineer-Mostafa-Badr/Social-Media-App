...
import 'package:social_media_app/feature/registration/data_helper.dart/validate.dart';
import 'package:social_media_app/data/data_helper/app_data.dart';
import 'package:social_media_app/data/model/result_api.dart';
import '../../../data/repository/firebase_auth.dart';
...
class RegistrationCubit extends Cubit<RegistrationState>
  ...
  void onTapBirthDay() {
    emit(state.copyWith(dialogsType: DialogsType.showDatePicker));
  }
