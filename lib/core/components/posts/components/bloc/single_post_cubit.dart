...
import '../../../../../data/repository/firebase_storge.dart';
...
class SinglePostCubit extends Cubit<SinglePostState> {
  ...
  Future<void> initData() async {
    bool isLike = state.postData.whoLikes.contains(
  ...
  Future<void> likePost(bool isLike) async {
    ...
    PostModel postModel = state.postData.copy(whoLikes: List.from(whoLikes));
    emit(state.copyWith(isLikePost: !state.isLikePost, postData: postModel));
  ...
  Future<void> addComments() async {
    ...
    PostModel postModel = state.postData.copy(comments: List.from(comments));
    emit(state.copyWith(postData: postModel));
