        ...
        return Column(
          children: [
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                  const AppIcon(icon: Icons.favorite, iconColor: Colors.red),
                  Flexible(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final String? userName =
                            state
                                .usersLikeAndComments[state.postData.whoLikes
                                    .elementAt(index)]
                                ?.name;
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  CommentModel commentModel = state.postData.comments.elementAt(
                    index,
                  );
                  UserApp? userApp =
